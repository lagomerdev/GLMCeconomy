...
public class BalanceRemoveRequest extends RequestPacket {
    private static final PacketInfo PACKET_INFO = EconomyPacketRegistry.ECONOMY.BALANCE_REMOVE_REQUEST;

    private final UUID accountUniqueId;
    private final BigDecimal amount;

    public BalanceRemoveRequest(UUID accountUniqueId, BigDecimal amount) {
